  ...
  return (
    ...
    >
      <div className="flex flex-col p-[2px] md:p-1 h-full w-full justify-between items-center relative z-10 text-center">
        ...
        <Landmark className="w-[10px] md:w-3.5 h-[10px] md:h-3.5 text-amber-500 my-[1px] md:my-0.5" />

        <span className="text-[6px] md:text-[8px] lg:text-[9px] font-black text-rose-600 font-mono">
          Pay ₹{tile.cost || 1000}
        </span>
      </div>
